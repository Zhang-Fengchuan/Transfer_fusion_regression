classdef Auxiliary_heterogeneity_regression
    methods
        ...
        function [Results,results,Results_opt,results_opt,...
                initial,Results_list_opt,Results_single_opt,Class_summary, num_partitions_best,combine_principle_best,split_principle_best,random_number_best, partitions] = Auxiliary_heterogeneous_regression(obj,simulation_size,simulation_index,Data_x,y_real,sample_size,p,beta_real,...
                ...
                iter_max2,eps2,iter_max_in,eps_in, eps_in_in,iter_max_in_in,full_if,real_evaluate,t)
            ...
            if length(simulation_index) > 1
                parfor local_i = 1:simulation_size  %!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    ...
                    if initial_if == 0
                        ...
                        [beta0, partitions, result, num_partitions_best,combine_principle_best,split_principle_best,random_number_best] = obj_initial.k_means_regression_initial(num_partitions_list, eps_out,...
