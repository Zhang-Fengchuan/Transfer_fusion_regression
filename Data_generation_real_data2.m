function [simulation_size, X_target, Y_target, sample_size, p, beta_target_real] = Data_generation_real_data2(which_index)
if which_index == 0
    ...
    % X_target = table2array(X(:,{'Data_age', 'Data_sex', 'Data_behavior', 'Data_site_detail', 'Data_summary_stage',...
        ...
        X_target = table2array(X(:,{'NCOA1', 'FOS', 'JUN', 'SP1', 'PGR', ...
        'TNFSF11', 'FGF17', 'FGF16', 'FGF18', 'FGFR1', ...
        'SOS1', 'MAP2K1', 'PIK3R1', 'AKT2', 'NOTCH1', ...
        'HES1', 'HEY1', 'NFKB2', 'WNT3A', 'FZD7', 'FZD10', ...
        'CTNNB1', 'POLK', 'E2F2', 'BRCA2'}));
    %X_target = table2array(X(:,{'NCOA1', 'FOS', 'JUN', 'SP1', 'PGR'}));
