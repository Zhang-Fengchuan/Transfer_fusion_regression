classdef  Transfer_heterogeneity_regression_pro
    methods
        ...
        function [Results,results,Results_opt,results_opt,...
                initial,Results_list_opt,Results_single_opt,Class_summary, num_partitions_best,combine_principle_best,split_principle_best,random_number_best, partitions] = Transfer_heterogeneous_regression_pro(obj,Auxiliary_dateset_number, Auxiliary, multi_if,...
                ...
                iter_max_in, eps_in, c_lambda2_start, c_lambda2_end, eps_in_in, iter_max_in_in, real_evaluate, t)
            %
            %-----------------------------------输出参数------------------------------------------%
